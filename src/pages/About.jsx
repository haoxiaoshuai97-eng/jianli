      ...
      <div className="about-content">
        ...
        >
          ...
          <div className="bio-text">
            ...
            <p>
              我的职业路径覆盖了游戏动效、三维动画、教育动画到产品动效的完整领域。从早期在游戏项目中使用 Spine 制作角色动画与交互动效，到后来在教育领域深耕三维动画与角色绑定，再到现在在字节跳动负责抖音直播的核心动效设计——这些经历让我既有扎实的动画基础，也有产品思维。
            </p>
            <p>
            ...
            <p>
              在 AI 工具应用上，我有自己的思考：AI 的输出质量取决于上下文质量，
              而维护上下文的成本由人来承担——这是使用 AI 的核心矛盾。
              我通过构建可复用的 Skill 模块（预制上下文），解决了重复交代的问题，
              让 AI 真正成为设计脑暴和业务分析的高效搭档。
            </p>
